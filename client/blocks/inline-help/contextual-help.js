...
const fallbackLinks = [
	{
		...
		title: 'Upload Custom Plugins and Themes',
...
const contextLinksForSection = {
	stats: [
		{
			...
			title: 'Understand the Stats Page',
			description:
	...
	media: [
		...
		},
		{
			...
			title: 'Find Free Images and other Media',
			description:
	...
	people: [
		...
		},
		{
			...
			title: 'Invite Contributors, Followers, and Viewers',
			description:
	...
	reader: [
		...
		},
		{
			...
			title: 'Follow Specific Topics in the Reader',
			description:
	...
	help: [
		...
		},
		{
			...
			title: 'Help! Get WordPress.com Support',
			description:
